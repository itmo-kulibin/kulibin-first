...
<EmbeddedBlock title="Любопытный факт">
  ...
  <EmbeddedBlockText slot="full">
    В 1772 году Лондонская академия назначила большую премию тому, кто сделает лучшую модель одновременного моста, без свай, концы которого упирались бы только на берегах реки. 
    Модель Кулибина полностью соответствовала требованиям, однако он отказался посылать проект в Англию, ведь очень хотел построить мост именно в России, на Неве, а не на Темзе.
  </EmbeddedBlockText>
</EmbeddedBlock>
